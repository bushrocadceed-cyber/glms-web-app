...
function adminInputClasses(hasError) {
...
export default function RegisterAdminModal({ submitting, cooldownSeconds = 0, onClose, onSubmit }) {
  ...
  function validate() {
    ...
    } else if (!ADMIN_EMAIL_PATTERN.test(form.email.trim())) {
  ...
  return (
    <Modal title="Register New Admin" onClose={onClose}>
      <div className="mb-4 rounded-lg bg-primary-50 px-3 py-2.5 text-xs text-primary-700">
        This creates a real login and grants <strong>Admin</strong> access right away. In the rare case
        the automatic promotion step doesn't go through, you'll see a message telling you to promote
        them manually from Edit.
      </div>
        ...
        <fieldset disabled={submitting} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={adminInputClasses(errors.fullName)}
            />
          ...
          <div>
            ...
            <input
              ...
              value={form.email}
              onChange={handleChange}
              className={adminInputClasses(errors.email)}
            />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                value={form.password}
                onChange={handleChange}
                className={`${adminInputClasses(errors.password)} pr-10`}
              />
              <button
                type="button"
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={adminInputClasses(errors.confirmPassword)}
            />
          ...
          <div>
            ...
            <input
              ...
              value={form.phone}
              onChange={handleChange}
              className={adminInputClasses(false)}
            />
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <label className={adminInputClasses(errors.avatar) + ' flex cursor-pointer items-center gap-2 hover:bg-slate-50'}>
